...
Opinionated rule settings to be used with [ESLint](http://eslint.org/). Can be used with ESLint v3.17.1 and eslint-plugin-react v6.10.0, or above.
![npm version](https://img.shields.io/npm/v/eslint-config-remitbri.svg)
